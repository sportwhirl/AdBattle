...
async function page({ duplicate = "passed" } = {}) {
  ...
  const state = {
    ad: { id: "3", owner_id: "owner", title: "Windmill", caption: "Test creative",
      safety_status: "held", duplicate_status: duplicate, moderation_status: "pending_scan" },
    calls: [], history: [], queueFailure: null, queueGate: null, lostResponse: false,
  };
  const saved = new Map();
